...
export module mo_yanxi.backend.vulkan.renderer.attachment_manager;
...
namespace mo_yanxi::backend::vulkan {
    ...
    public:
        ...
        [[nodiscard]] vk::dynamic_rendering get_dynamic_rendering(bool use_multisample_target) const {
            if (use_multisample_target && enables_multisample()) {
                ...
                return vk::dynamic_rendering{
                    get_draw_attachments() | std::views::transform(&vk::combined_image::get_image_view),
                    nullptr
                };
            }
        }
