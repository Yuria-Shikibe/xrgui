...
public:
    referenced_ptr<const style::slider1d_drawer> drawer_{(post_sync_execute(*this, [](slider1d& s){
...
public:
	referenced_ptr<const style::slider2d_drawer> drawer_{(post_sync_execute(*this, [](slider2d& s){
